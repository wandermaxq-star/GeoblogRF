import { CuratedRoutePack } from '../types/proRoutePacks';

export const PRO_ROUTE_PACKS: CuratedRoutePack[] = [
  {
    id: 'golden-ring',
...
export const DEFAULT_PRO_ROUTE_PACK_ID = PRO_ROUTE_PACKS[0]?.id ?? null;