...
export const REGIONS_GEO: Record<string, RegionGeo> = {
  ...
  moscow_oblast:     { center: [38.2, 55.3],   federalDistrict: 'ЦФО', area: 44329,  label: 'Моск. обл.',   capital: 'Красногорск',      capitalCoords: [37.33, 55.82] },
  belgorod_oblast:   { center: [37.0, 50.8],   federalDistrict: 'ЦФО', area: 27134,  label: 'Белгород',     capital: 'Белгород',         capitalCoords: [36.59, 50.60] },
  bryansk_oblast:    { center: [33.5, 53.0],   federalDistrict: 'ЦФО', area: 34857,  label: 'Брянск',       capital: 'Брянск',           capitalCoords: [34.36, 53.24] },
  vladimir_oblast:   { center: [40.6, 56.3],   federalDistrict: 'ЦФО', area: 29084,  label: 'Владимир',     capital: 'Владимир',         capitalCoords: [40.41, 56.13] },
  voronezh_oblast:   { center: [40.0, 51.3],   federalDistrict: 'ЦФО', area: 52216,  label: 'Воронеж',      capital: 'Воронеж',          capitalCoords: [39.20, 51.66] },
  ivanovo_oblast:    { center: [41.5, 57.1],   federalDistrict: 'ЦФО', area: 21437,  label: 'Иваново',      capital: 'Иваново',          capitalCoords: [40.97, 56.99] },
  kaluga_oblast:     { center: [35.8, 54.3],   federalDistrict: 'ЦФО', area: 29777,  label: 'Калуга',       capital: 'Калуга',           capitalCoords: [36.27, 54.51] },
  kostroma_oblast:   { center: [43.5, 58.2],   federalDistrict: 'ЦФО', area: 60211,  label: 'Кострома',     capital: 'Кострома',         capitalCoords: [40.93, 57.77] },
  kursk_oblast:      { center: [36.5, 51.7],   federalDistrict: 'ЦФО', area: 29997,  label: 'Курск',        capital: 'Курск',            capitalCoords: [36.19, 51.73] },
  lipetsk_oblast:    { center: [39.5, 52.5],   federalDistrict: 'ЦФО', area: 24047,  label: 'Липецк',       capital: 'Липецк',           capitalCoords: [39.57, 52.61] },
  oryol_oblast:      { center: [36.3, 52.8],   federalDistrict: 'ЦФО', area: 24652,  label: 'Орёл',         capital: 'Орёл',             capitalCoords: [36.06, 52.97] },
  ryazan_oblast:     { center: [40.5, 54.5],   federalDistrict: 'ЦФО', area: 39605,  label: 'Рязань',       capital: 'Рязань',           capitalCoords: [39.72, 54.63] },
  smolensk_oblast:   { center: [32.5, 55.0],   federalDistrict: 'ЦФО', area: 49779,  label: 'Смоленск',     capital: 'Смоленск',         capitalCoords: [32.05, 54.78] },
  tambov_oblast:     { center: [41.5, 52.5],   federalDistrict: 'ЦФО', area: 34462,  label: 'Тамбов',       capital: 'Тамбов',           capitalCoords: [41.43, 52.72] },
  tver_oblast:       { center: [35.5, 57.0],   federalDistrict: 'ЦФО', area: 84201,  label: 'Тверь',        capital: 'Тверь',            capitalCoords: [35.89, 56.86] },
  tula_oblast:       { center: [37.6, 54.0],   federalDistrict: 'ЦФО', area: 25679,  label: 'Тула',         capital: 'Тула',             capitalCoords: [37.62, 54.19] },
  yaroslavl_oblast:  { center: [39.5, 57.7],   federalDistrict: 'ЦФО', area: 36177,  label: 'Ярославль',    capital: 'Ярославль',        capitalCoords: [39.89, 57.63] },

  // ═══ СЗФО ═══
  spb:               { center: [30.3, 59.9],   federalDistrict: 'СЗФО', area: 1439,   label: 'СПб',          capital: 'Санкт-Петербург',  capitalCoords: [30.32, 59.94] },
  leningrad_oblast:  { center: [30.5, 60.5],   federalDistrict: 'СЗФО', area: 83908,  label: 'Лен. обл.',    capital: 'Гатчина',          capitalCoords: [30.13, 59.57] },
  arkhangelsk_oblast:{ center: [42.0, 63.5],   federalDistrict: 'СЗФО', area: 589913, label: 'Архангельск',   capital: 'Архангельск',      capitalCoords: [40.54, 64.54] },
  vologda_oblast:    { center: [39.5, 59.5],   federalDistrict: 'СЗФО', area: 144527, label: 'Вологда',      capital: 'Вологда',          capitalCoords: [39.88, 59.22] },
  kaliningrad_oblast:{ center: [20.5, 54.7],   federalDistrict: 'СЗФО', area: 15125,  label: 'Калининград',   capital: 'Калининград',      capitalCoords: [20.51, 54.71] },
  ...
  murmansk_oblast:   { center: [35.0, 68.5],   federalDistrict: 'СЗФО', area: 144900, label: 'Мурманск',     capital: 'Мурманск',         capitalCoords: [33.09, 68.97] },
  nenets_ao:         { center: [53.0, 68.0],   federalDistrict: 'СЗФО', area: 176810, label: 'НАО',          capital: 'Нарьян-Мар',       capitalCoords: [53.09, 67.64] },
  novgorod_oblast:   { center: [31.5, 58.3],   federalDistrict: 'СЗФО', area: 55300,  label: 'Новгород',     capital: 'Великий Новгород', capitalCoords: [31.28, 58.52] },
  pskov_oblast:      { center: [29.5, 57.0],   federalDistrict: 'СЗФО', area: 55300,  label: 'Псков',        capital: 'Псков',            capitalCoords: [28.33, 57.82] },

  // ═══ ЮФО ═══
  krasnodar_krai:    { center: [39.5, 45.5],   federalDistrict: 'ЮФО', area: 75485,  label: 'Краснодар',    capital: 'Краснодар',         capitalCoords: [38.98, 45.04] },
  adygea:            { center: [40.2, 44.8],   federalDistrict: 'ЮФО', area: 7792,   label: 'Адыгея',       capital: 'Майкоп',            capitalCoords: [40.10, 44.61] },
  astrakhan_oblast:  { center: [47.5, 46.5],   federalDistrict: 'ЮФО', area: 49024,  label: 'Астрахань',    capital: 'Астрахань',         capitalCoords: [48.03, 46.35] },
  volgograd_oblast:  { center: [43.5, 49.5],   federalDistrict: 'ЮФО', area: 112877, label: 'Волгоград',    capital: 'Волгоград',         capitalCoords: [44.51, 48.71] },
  ...
  rostov_oblast:     { center: [40.0, 47.5],   federalDistrict: 'ЮФО', area: 100967, label: 'Ростов',       capital: 'Ростов-на-Дону',    capitalCoords: [39.72, 47.24] },
  sevastopol:        { center: [33.5, 44.5],   federalDistrict: 'ЮФО', area: 864,    label: 'Севастополь',  capital: 'Севастополь',        capitalCoords: [33.52, 44.60] },

  // ═══ СКФО ═══
  stavropol_krai:    { center: [43.0, 44.5],   federalDistrict: 'СКФО', area: 66500, label: 'Ставрополь',   capital: 'Ставрополь',        capitalCoords: [41.97, 45.04] },
  ...
  kirov_oblast:      { center: [50.0, 58.5],   federalDistrict: 'ПФО', area: 120374, label: 'Киров',        capital: 'Киров',            capitalCoords: [49.66, 58.60] },
  ...
  nizhny_novgorod_oblast: { center: [44.0, 56.2], federalDistrict: 'ПФО', area: 76624, label: 'Н. Новгород', capital: 'Нижний Новгород', capitalCoords: [43.99, 56.33] },
  orenburg_oblast:   { center: [55.0, 51.8],   federalDistrict: 'ПФО', area: 123702, label: 'Оренбург',     capital: 'Оренбург',         capitalCoords: [55.10, 51.77] },
  penza_oblast:      { center: [44.5, 53.2],   federalDistrict: 'ПФО', area: 43352,  label: 'Пенза',        capital: 'Пенза',            capitalCoords: [45.02, 53.19] },
  perm_krai:         { center: [56.0, 58.5],   federalDistrict: 'ПФО', area: 160236, label: 'Пермь',        capital: 'Пермь',            capitalCoords: [56.25, 58.01] },
  samara_oblast:     { center: [50.5, 53.3],   federalDistrict: 'ПФО', area: 53565,  label: 'Самара',       capital: 'Самара',           capitalCoords: [50.15, 53.20] },
  saratov_oblast:    { center: [46.5, 51.8],   federalDistrict: 'ПФО', area: 101240, label: 'Саратов',      capital: 'Саратов',          capitalCoords: [46.03, 51.53] },
  ...
  ulyanovsk_oblast:  { center: [48.0, 54.0],   federalDistrict: 'ПФО', area: 37181,  label: 'Ульяновск',    capital: 'Ульяновск',        capitalCoords: [48.40, 54.31] },
  chuvashia:         { center: [47.0, 55.8],   federalDistrict: 'ПФО', area: 18343,  label: 'Чувашия',      capital: 'Чебоксары',        capitalCoords: [47.25, 56.13] },

  // ═══ УФО ═══
  kurgan_oblast:     { center: [64.5, 55.3],   federalDistrict: 'УФО', area: 71488,  label: 'Курган',       capital: 'Курган',           capitalCoords: [65.33, 55.44] },
  sverdlovsk_oblast: { center: [61.0, 57.0],   federalDistrict: 'УФО', area: 194307, label: 'Екатеринбург', capital: 'Екатеринбург',     capitalCoords: [60.60, 56.84] },
  tyumen_oblast:     { center: [68.0, 58.0],   federalDistrict: 'УФО', area: 160122, label: 'Тюмень',       capital: 'Тюмень',           capitalCoords: [68.25, 57.15] },
  chelyabinsk_oblast:{ center: [60.5, 54.7],   federalDistrict: 'УФО', area: 87900,  label: 'Челябинск',    capital: 'Челябинск',        capitalCoords: [61.40, 55.15] },
  ...
  altai_krai:        { center: [83.0, 52.5],   federalDistrict: 'СФО', area: 167996, label: 'Алт. край',    capital: 'Барнаул',          capitalCoords: [83.76, 53.35] },
  irkutsk_oblast:    { center: [106.0, 55.5],  federalDistrict: 'СФО', area: 774846, label: 'Иркутск',      capital: 'Иркутск',          capitalCoords: [104.28, 52.29] },
  kemerovo_oblast:   { center: [86.5, 54.5],   federalDistrict: 'СФО', area: 95725,  label: 'Кемерово',     capital: 'Кемерово',         capitalCoords: [86.09, 55.35] },
  krasnoyarsk_krai:  { center: [95.0, 64.0],   federalDistrict: 'СФО', area: 2366797,label: 'Красноярск',   capital: 'Красноярск',       capitalCoords: [92.87, 56.01] },
  novosibirsk_oblast:{ center: [79.5, 55.0],   federalDistrict: 'СФО', area: 177756, label: 'Новосибирск',  capital: 'Новосибирск',      capitalCoords: [82.92, 55.03] },
  omsk_oblast:       { center: [73.5, 55.5],   federalDistrict: 'СФО', area: 141140, label: 'Омск',         capital: 'Омск',             capitalCoords: [73.37, 54.99] },
  tomsk_oblast:      { center: [82.0, 58.5],   federalDistrict: 'СФО', area: 314391, label: 'Томск',        capital: 'Томск',            capitalCoords: [84.97, 56.49] },
  ...
  // ═══ ДФО ═══
  amur_oblast:       { center: [129.0, 53.0],  federalDistrict: 'ДФО', area: 361908, label: 'Амур',         capital: 'Благовещенск',     capitalCoords: [127.54, 50.29] },
  ...
  zabaykalsky_krai:  { center: [116.0, 52.5],  federalDistrict: 'ДФО', area: 431892, label: 'Забайкалье',   capital: 'Чита',             capitalCoords: [113.50, 52.03] },
  kamchatka_krai:    { center: [159.0, 56.0],  federalDistrict: 'ДФО', area: 464275, label: 'Камчатка',     capital: 'Петропавловск-Камч.',capitalCoords: [158.65, 53.01] },
  magadan_oblast:    { center: [152.0, 62.0],  federalDistrict: 'ДФО', area: 462464, label: 'Магадан',      capital: 'Магадан',           capitalCoords: [150.80, 59.56] },
  primorsky_krai:    { center: [134.0, 44.5],  federalDistrict: 'ДФО', area: 164673, label: 'Приморье',     capital: 'Владивосток',       capitalCoords: [131.89, 43.12] },
  sakhalin_oblast:   { center: [143.0, 50.0],  federalDistrict: 'ДФО', area: 87101,  label: 'Сахалин',      capital: 'Южно-Сахалинск',    capitalCoords: [142.74, 46.96] },
  khabarovsk_krai:   { center: [135.0, 54.0],  federalDistrict: 'ДФО', area: 787633, label: 'Хабаровск',    capital: 'Хабаровск',         capitalCoords: [135.07, 48.48] },
